                    ...
                    <div className='flex flex-col gap-10'>
                        <div className='flex flex-col gap-4'>
                            <div className='relative mb-10'>
                                <h3 className='absolute -left-6 px-6 py-2.5 bg-custom-green-two text-white font-bold'>Test 1</h3>
                            </div>
                        ...
                        <div className='flex flex-row w-full justify-between'>
                            <Link to={'/lecturer/tests/courseid'} className='w-fit mb-6'>
                            ...
                            <Link to={'/lecturer/tests/courseid/scores'} className='w-fit mb-6'>
