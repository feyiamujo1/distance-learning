      ...
      <div className='flex flex-col gap-16 w-11/12 mx-auto'>
        ...
        <div className='flex flex-col gap-3'>
          <NavLink to='/' className= {path.includes("dashboard") || path === "dashboard"
                ? ActiveNavLink
                : normalNavLink}><ImHome  className='text-lg'/>
            <p>Dashboard</p>
          </NavLink>
          <NavLink to='/student/courses' className= {path.includes("courses") || path === "courses" 
                ? ActiveNavLink
                : normalNavLink}>
            <MdMenuBook className='text-xl' />
            Courses
          </NavLink>
          <NavLink to='/student/assignments' className= {path.includes("assignments") || path === "assignments" 
                ? ActiveNavLink
                : normalNavLink}>
            <MdNoteAlt className='text-xl' />
            Assignments
          </NavLink>
          <NavLink to='/student/tests' className= {path.includes("tests") || path === "tests" 
                ? ActiveNavLink
                : normalNavLink}>
            <MdScore className='text-xl'/>
            Tests
          </NavLink>
          <NavLink to='/student/announcements' className= {path.includes("announcements") || path === "announcements" 
                ? ActiveNavLink
                : normalNavLink}>
