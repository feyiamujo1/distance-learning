    ...
    <div className='px-10 py-11 h-full'>
        <div className='min-h-screen w-full p-6 bg-white rounded-md flex flex-col gap-4'>
            ...
            <div className='flex flex-wrap justify-around gap-2'>
                <Link to='/student/courses/cmp321' className='w-[230px] flex flex-col justify-between gap-4 py-6 px-5 pb-4 mb-4 box-border shadow-nav-shadow rounded-md group cursor-pointer hover:bg-custom-off-white ease-in-out duration-500 hover:-translate-y-3.5'>
